...
export const WAVE_WINDOWS: WaveWindow[] = [
  ...
  { no: 5, key: "w5", label: "5便", start: "18:00", end: "20:00" },
  { no: 6, key: "w6", label: "6便", start: "20:00", end: "22:00" },
];

/** 積み込み時間帯（配達Waveではない。始業の積込作業）。表示・実績参照用。 */
export const LOADING_WINDOW = { key: "loading", label: "積み込み", start: "08:30", end: "09:00" } as const;
